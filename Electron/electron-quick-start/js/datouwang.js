...
(function () {
  ...
  this.Waves = function (datouwang, options) {
    var Waves = this;
    ...
    Waves.datouwang = document.querySelector(datouwang);
    Waves.canvas = document.createElement('canvas');
    Waves.ctx = Waves.canvas.getContext('2d');
    Waves.datouwang.appendChild(Waves.canvas);
  ...
  Waves.prototype.resize = function () {
    var Waves = this;
    var width = Waves.datouwang.offsetWidth;
    var height = Waves.datouwang.offsetHeight;
